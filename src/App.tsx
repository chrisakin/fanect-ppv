...
import { Ticket, Play, Calendar, Lock, Mail, CreditCard } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              {user ? (
                <>
                  <button className="px-4 py-2 rounded-full bg-purple-600 hover:bg-purple-700 transition">
                    Purchase Ticket
                  </button>
                  <button className="px-4 py-2 rounded-full border border-gray-600 hover:border-purple-500 transition">
                    Enter Stream
                  </button>
                ...
                <>
                  <button
                    ...
                    className="px-4 py-2 rounded-full border border-gray-600 hover:border-purple-500 transition"
                  >
                    Sign In
                  </button>
                  <button
            ...
            <div className="bg-gray-800 rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button className="flex items-center space-x-2 px-4 py-2 bg-purple-600 rounded-full hover:bg-purple-700 transition">
